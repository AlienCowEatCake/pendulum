...
#if !defined (PHYSICALLABCORE_OBJECTSCONNECTOR_H_INCLUDED)
#define PHYSICALLABCORE_OBJECTSCONNECTOR_H_INCLUDED
...
#endif // PHYSICALLABCORE_OBJECTSCONNECTOR_H_INCLUDED
